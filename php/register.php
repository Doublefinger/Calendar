...
<div>
    ...
    <div class="container">
        <form class="form-signin" action="../php/validate.php" method="POST">
            <h2 class="form-signin-heading">Module 3</h2>
            <input type="text" name="register" value="1" hidden="hidden">
            ...
            if ($fail == 1) {
                ...
                echo '<div class="alert alert-danger" role="alert">The user name already exists.</div>';
            }
